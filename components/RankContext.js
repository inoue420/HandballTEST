...
export const RankProvider = ({ children }) => {
  ...
  const ranks = [
    ...
    { name: '(ランク4) レギュラープレイヤー', threshold: 15 },
    ...
    { name: '(ランク10) オーバーステップ後、笛が鳴るより早くボールを置くプレイヤー', threshold: 50 },
    { name: '(ランク11) コート上の監督', threshold: 60 },
    { name: '(ランク12) 駆け出しレフェリー', threshold: 70 },
    { name: '(ランク13) 飲み会に笛を持参するレフェリー', threshold: 80 },
    { name: '(ランク14) 飲み会に笛とイエローカードを持参するレフェリー', threshold: 90 },
    { name: '(ランク15) テンションが高い時、2ステップ踏んで2分間退場出すレフェリー', threshold: 100 },
    { name: '(ランク16) B級レフェリー', threshold: 150 },
    { name: '(ランク17) 飲み会でぼけた人がいたらタイムアウトジェスチャーをするレフェリー', threshold: 200 },
